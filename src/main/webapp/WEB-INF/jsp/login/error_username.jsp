...
<html>
<head>
    <title>Cuenta no existente</title>
...
<div class="row">
    ...
    <div class="col s6 z-depth-1-half">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img z-depth-3" src="/images/usernotexist.png">
        </div>
        <div class="card  blue-grey darken-1">
            <div class="card-content white-text">
                <span class="card-title">Aviso</span>
                <p>La cuenta a la que estás intentando iniciar sesión no existe.
